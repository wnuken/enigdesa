  <div class="topview1 row">
    ...
    <div class="col-sm-4 col-md-3 pull-right">
      ...
      <div class="redes hidden-xs">
        <div class="col-md-11"> <a href="http://www.youtube.com/DaneColombia" target="_blank">
          <div class="yt"></div>
          </a> <a href="https://www.facebook.com/DANEColombia" target="_blank">
          <div class="fb"></div>
          </a> <a href="https://twitter.com/DANE_Colombia" target="_blank">
          <div class="tw"></div>
          </a> <a href="https://mail.dane.gov.co/" target="_blank">
          <div class="ml"></div>
          </a> </div>
      </div>
    </div>
  ...
  <nav class="topview2 container-fluid navbar navbar-default navbar-fixed-top hidden">
    <div class="row container-fluid">
      ...
      <div class="row col-xs-10 col-sm-10 col-md-11" id="bar">
        <div class="row hidden hidden-xs col-sm-12 col-md-4 pull-right">
          <div class="row col-sm-10 col-md-10"> <small>Martes, 18 de noviembre de 2.014</small> </div>
          <div class="row col-sm-3 col-md-3 pull-right"> <small><a class="btn-link" href="#">English</a></small> </div>
        </div>
        <div class="col-md-12 pull-right">
          <div class="row">
            <div id="tituloMini" class="col-md-9 text-left hidden-xs">
              <h4>Encuesta Nacional de Presupuestos de los Hogares</h4>
            </div>
            <div class="col-md-3 .col-md-offset-1 redes hidden-xs"> <a href="http://www.youtube.com/DaneColombia" target="_blank">
              <div class="yt"></div>
              </a> <a href="https://www.facebook.com/DANEColombia" target="_blank">
              <div class="fb"></div>
              </a> <a href="https://twitter.com/DANE_Colombia" target="_blank">
...
<nav class="navbar navbar-default navbar-fixed-top" style="z-index: 20000">
    ...
    <div class="row">
    	<div class="navbar-header col-xs-12 col-sm-12 col-md-7 col-md-offset-1 col-lg-7 col-md-offset-1">
          	<a class="navbar-brand" href="<?php echo site_url("/inicio"); ?>"> <img src="<?php echo base_url("images/logo-enig.png"); ?>">  </a>
        </div>
	</div>
