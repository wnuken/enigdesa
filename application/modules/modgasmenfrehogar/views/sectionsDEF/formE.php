						...
						<div ng-repeat="rhom in Formulario.rh">
							<div class="form-group has-feedback" id="div-{{rhom.id}}">
								<div class="col-sm-8" id="page1">
									<div class="checkbox">
										<input type="checkbox" name="{{rhom.id}}" id="{{rhom.id}}" class="form-control" 
							...
							<div class="col-sm-8">
							<div class="checkbox">
								<input type="checkbox" name="novalida" id="novalida" class="form-control" ng-model="noValida" ng-disabled="activeBtnS1">
								<label><b>Ninguna de las anteriores</b>
								</label>
								</div>
							</div>
							<div class="row">
