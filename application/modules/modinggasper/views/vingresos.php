<hr />
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<h4><?echo $persona['P521A'] ." ". $persona['P521C']; ?></h4>
			</div>
		</div>
		<br />
<?
...
<?php
	if ($secc['ANTERIOR'] == 'SI') {
		echo "		<button class='btn btn-info' onClick='window.location.replace(\"". site_url("modinggasper/Personas/antingresos") ."\");'><span class='glyphicon glyphicon-chevron-left' aria-hidden='true' title='Volver'></span>Regresar y Modificar</button>\n";
	}
...
?>
	...
	$('[name=P6450]').dependencias('P6450', 'GRP_P1652', [2]);
});
</script>