...
/**
 * Controlador para el submodulo de gastos en electrodomesticos, muebles, enseres, utensilios domesticos y lenceria para el hogar
 * @author oagarzond
 * @since 2016-06-20
 */
class Emeudlh extends MX_Controller {
